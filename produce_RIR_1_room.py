...
if __name__ == "__main__":
    ...
    delta_dims  = 0.0                         # The range of random size variation ±0.5
    ...
    for room_dim in room_dims:
        ...
        # 30*30 mic positions
        x_mic_posis = np.linspace(edges[0], room_dim_noedge[0], 30)     
        y_mic_posis = np.linspace(edges[1], room_dim_noedge[1], 30)
        mic_z = 1.5
        ...
        total_mic_posis.append(mic_xyz_posis) # list

    # distance range 
    dis_range = [0.1, 6]
    
    # distance setting
    root_path = os.getcwd()+'/dataset/FramRIRs/RIR_1room_900mic_50src_0224'
